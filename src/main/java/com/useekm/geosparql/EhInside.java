...
/**
 * OGC GeoSPARQL geof:ehInside implementation
 */
public class EhInside extends AbstractBooleanBinaryFunction {
    @Override public String getURI() {
        return GeoConstants.GEOF_EH_INSIDE.stringValue();
    }

    @Override protected boolean accept(ValueFactory valueFactory, Geometry geom1, Geometry geom2, Value... allArgs) {
        return geom1.relate(geom2).matches("TFF*FFT**");
    }
}