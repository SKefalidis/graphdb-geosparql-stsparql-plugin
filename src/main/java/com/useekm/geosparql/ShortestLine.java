 ...
 */
public class ShortestLine extends AbstractLiteralBinaryFunction implements GeometryFunction {
    @Override public String getURI() {
        return GeoConstants.EXT_SHORTEST_LINE.stringValue();
    }

    @Override protected Literal evaluate(ValueFactory valueFactory, IRI geotype, Geometry geom1, Geometry geom2, Value... originals) {
        ...
        return GeoConvert.toLiteralExpr(valueFactory, result, geotype);
    }
}