...
public class Simplify extends AbstractGeomGeomDoubleFunction {
    @Override public String getURI() {
        return GeoConstants.EXT_SIMPLIFY.stringValue();
    }

    @Override protected Literal evaluate(ValueFactory valueFactory, IRI geotype, Geometry geom, double distanceTolerance) {
        return GeoConvert.toLiteral(valueFactory, DouglasPeuckerSimplifier.simplify(geom, distanceTolerance), geotype);
    }
}