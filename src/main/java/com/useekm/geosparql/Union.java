 ...
 */
public class Union extends AbstractLiteralBinaryFunction implements GeometryFunction {
    @Override public String getURI() {
        return GeoConstants.GEOF_UNION.stringValue();
    }
    ...
    @Override protected Literal evaluate(ValueFactory valueFactory, IRI geotype, Geometry geom1, Geometry geom2, Value... originals) throws ValueExprEvaluationException {
        return GeoConvert.toLiteralExpr(valueFactory, geom1.union(geom2), geotype);
    }
}