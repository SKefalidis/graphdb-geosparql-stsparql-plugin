...
public final class WktOgcSerializer extends WktSerializer {
    public static final WktOgcSerializer INTANCE = new WktOgcSerializer();

    private WktOgcSerializer() {}
